...
const fontsToLoad = {
  ...
  firaCode500: readFile(
    new URL(`${pathPrefix}/fira-code-latin-500-normal.woff`, import.meta.url)
  ),
  firaCode700: readFile(
    new URL(`${pathPrefix}/fira-code-latin-700-normal.woff`, import.meta.url)
  )
}
